    ...
    public static class Program
    {
        ...
        static void ReadConfig()
        {
            ...
            if (runSetup)
            {
                ...
                logger.Write("Please enter the subdirectory to the custom folder containing your autoexec. (eg C:\\Program Files (x86)\\Steam\\SteamApps\\common\\Team Fortress 2\\tf\\custom\\customstuff\\) :  ", Logger.LogLevel.Info);
